...
Bird = pygame.image.load('Python_Ai/data/Bird002.png')
Cactus = pygame.image.load('Python_Ai/data/Cactus001.png')
DinoDuck = pygame.image.load('Python_Ai/data/DinoDuck004.png')
DinoWalk = pygame.image.load('Python_Ai/data/DinoWalk002.png')
